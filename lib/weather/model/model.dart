...
class Model {
  ...
  Widget? getAirIcon(int index) {
    if (index == 1) {
      return Image.asset(
        'asset/img/air_condition/good.png',
        width: 37.0,
        height: 35.0,
      );
    } else if (index == 2) {
      return Image.asset(
        'asset/img/air_condition_icon/fair.png',
        width: 37.0,
        height: 35.0,
      );
    } else if (index == 3) {
      return Image.asset(
        'asset/img/air_condition_icon/moderate.png',
        width: 37.0,
        height: 35.0,
      );
    } else if (index == 4) {
      return Image.asset(
        'asset/img/air_condition_icon/poor.png',
        width: 37.0,
        height: 35.0,
      );
    } else if (index == 5) {
      return Image.asset(
        'asset/img/air_condition_icon/abd.png',
        width: 37.0,
        height: 35.0,
      );
    }
